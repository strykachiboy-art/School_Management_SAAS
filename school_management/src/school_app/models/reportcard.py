...
class ReportCard(db.Model):
    ...
    # Calculated snapshot of the student's term performance.
    summary_data = db.Column(
        db.JSON,
        nullable=True,
    )

    # Opaque public reference.
    public_reference = db.Column(
        db.String(64),
        unique=True,
        nullable=False,
        index=True,
    ...
    # Secure hash for verification PIN.
    access_pin_hash = db.Column(
        db.String(255),
        nullable=True,
    )
