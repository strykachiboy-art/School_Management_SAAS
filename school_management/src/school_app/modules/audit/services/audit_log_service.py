...
def create_audit_log(
    ...
    """
    Creates and flushes a new audit log entry.
    school_id is optional because AuditLog supports both:
    - school-scoped actions
    - platform/super-admin actions without a school
    """
    log = AuditLog(
        school_id=school_id,
        actor_id=actor_id,
...
def get_filtered_audit_logs(
    ...
    """Dynamically queries audit logs using the supplied filters."""
    ...
    if school_id is not None:
        stmt = stmt.filter_by(school_id=school_id)
