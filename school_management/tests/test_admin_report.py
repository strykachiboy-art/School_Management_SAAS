...
def test_get_admin_report_overview_endpoint(
    client,
    admin_headers,
    student,
    school,
...
def test_get_admin_report_academic_endpoint(
    client,
    admin_headers,
):
    response = client.get(
        "/admin/reports/academic?session_id=1&classroom_id=1",
        headers=admin_headers,
    )
...
def test_get_admin_report_attendance_endpoint(
    client,
    admin_headers,
):
    response = client.get(
...
def test_get_admin_report_classrooms_endpoint(
    client,
    admin_headers,
):
    response = client.get(
        "/admin/reports/classrooms?session_id=1",
        headers=admin_headers,
    )
...
def test_get_admin_report_students_endpoint(
    client,
    admin_headers,
):
    response = client.get(
        "/admin/reports/students"
        "?gender=Female&is_active=true&start_date=2025-09-01",
        headers=admin_headers,
    )
...
def test_get_admin_report_teachers_endpoint(
    client,
    admin_headers,
):
    response = client.get(
        "/admin/reports/teachers?gender=Male&is_active=false",
        headers=admin_headers,
    )
